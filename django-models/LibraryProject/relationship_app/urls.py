...
urlpatterns = [
    ...
    path('list_books/change', views.ChangeBookView.as_view(), name='change_book'),
    path('list_book/add', views.BookAddView.as_view(), name='add_book'),
    path('list_books/delete', views.DeleteBookView.as_view(), name='delete_book')
]
